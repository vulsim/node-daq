				...
				that.getOperatingParams(rawReadFunc, rawWriteFunc, function (err2, operatingParams) {
					try {
						...
						cb(null, {
							...
							"h1": operatingParams["1"]["T"],
							"he1": operatingParams["1"]["T!"],
							"g11": parseFloat(operatingParams["1"]["v>"]),
							"p11": parseFloat(operatingParams["1"]["q>"]),
							"q11": parseFloat(operatingParams["1"]["Q"]),							
							"v11": parseFloat(operatingParams["1"]["V>"]),							
							"t11": parseFloat(operatingParams["1"]["t>"]),
							"t12": parseFloat(operatingParams["1"]["t<"]),							
							"errors1": operatingParams["1"]["!?"],
							"h2": operatingParams["2"]["T"],
							"he2": operatingParams["2"]["T!"],
